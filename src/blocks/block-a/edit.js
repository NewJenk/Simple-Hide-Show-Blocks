...
export default function Edit( {attributes, setAttributes, clientId} ) {
	...
	const blockA = shsbGlobal.activeValue;
		...
		<div { ...useBlockProps() }>
			<InspectorControls>
				...
				>
					...
					{el( 'a', { href: 'https://example.com' }, 'This should work..' )} */}
				...
				>
					{
						...
						blockA == 'a' ? __('\'Block A\' is selected on the options screen, so this content will display.', 'simple-hide-show-blocks') : __('\'Block A\' is not selected on the options screen, so this content won\'t display.', 'simple-hide-show-blocks')
					}
				</div>
			</InspectorControls>
			<header
			...
			>
				...
				>
					{ __('The content below will be visible if \'Block A\' is selected on the options screen.', 'simple-hide-show-blocks') }
					<span
						style={{
							display: 'block',
							'font-size': '10px',
			...
			>
				...
				>
					{ __('End of content that\'s visible if \'Block A\' is selected on the options screen.', 'simple-hide-show-blocks') }
				</em>
			</footer>
		</div>
